...
const exampleOrders = [
    {
        ...
        dateOrdered: new Date('2024-03-02'),
        datePickup: new Date('2024-03-05'),
        status: 'Pending',
        __v: 0,
    },
    {
        ...
        orderDes: 'Special Instructions',
        address: '123 Banana St',
        dateOrdered: new Date('2024-03-04'),
        datePickup: new Date('2024-03-20'),
        status: 'Completed',
        __v: 0,
    },
    {
        ...
        datePickup: new Date('2024-03-01'),
        status: 'Cancelled',
        __v: 0,
    },
    {
        ...
        <>
            ...
            <main className={styles.dashboard}>
                ...
                <div className={styles['content']}>
                    <Routes>
                        <Route path="/" element={<FullCalendar orders={exampleOrders} />} />
